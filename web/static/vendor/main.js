...
var _user$project$MyModels$GroupModel = F4(
	function (a, b, c, d) {
		return {id: a, kind: b, title: c, songs: d};
	});
var _user$project$MyModels$QueueModel = F4(
	function (a, b, c, d) {
		return {array: a, mouseOver: b, mouseOverItem: c, currentSong: d};
	});
var _user$project$MyModels$BrowserModel = F3(
	function (a, b, c) {
		return {isMouseOver: a, items: b, isUploading: c};
	});
var _user$project$MyModels$QueueItemModel = F3(
	function (a, b, c) {
		return {isSelected: a, isMouseOver: b, song: c};
	});
...
var _user$project$ApiHelpers$songEncoder = function (song) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$int(song.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'path',
					_1: _elm_lang$core$Json_Encode$string(song.path)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'title',
						_1: _elm_lang$core$Json_Encode$string(song.title)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'artist',
							_1: _elm_lang$core$Json_Encode$string(song.artist)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'album',
								_1: _elm_lang$core$Json_Encode$string(song.album)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'track',
									_1: _elm_lang$core$Json_Encode$int(song.track)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$ApiHelpers$songsEncoder = function (songs) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$ApiHelpers$songEncoder, songs))
			},
			_1: {ctor: '[]'}
		});
};
...
var _user$project$ApiHelpers$decodeSync = function (raw) {
	var currentSong = A2(
		_elm_lang$core$Json_Decode$decodeValue,
		A2(_elm_lang$core$Json_Decode$field, 'current_song', _elm_lang$core$Json_Decode$int),
		raw);
	var songs = _user$project$ApiHelpers$decodeSongs(raw);
	var _p0 = songs;
	if (_p0.ctor === 'Ok') {
		var _p1 = currentSong;
		if (_p1.ctor === 'Ok') {
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: _p1._0, _1: _p0._0});
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	} else {
	...
	return A2(
		_elm_lang$html$Html$p,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$MyStyle$grey},
					_1: {
						ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_jystic$elm_font_awesome$FontAwesome$arrow_right, _elm_lang$core$Color$white, 25),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$SortSongs$byAlbumAndTrackQ = _elm_lang$core$List$sortWith(
	F2(
		function (item1, item2) {
			var _p6 = A2(_elm_lang$core$Basics$compare, item1.song.album, item2.song.album);
			if (_p6.ctor === 'EQ') {
				return A2(_elm_lang$core$Basics$compare, item1.song.track, item2.song.track);
			} else {
				return _p6;
			}
		}));
var _user$project$SortSongs$byAlbumAndTrack = _elm_lang$core$List$sortWith(
	F2(
		function (item1, item2) {
			var _p7 = A2(_elm_lang$core$Basics$compare, item1.album, item2.album);
			if (_p7.ctor === 'EQ') {
				return A2(_elm_lang$core$Basics$compare, item1.track, item2.track);
			} else {
				return _p7;
			}
		}));
...
var _user$project$Browser$navigationView = function (model) {
	return A2(
...
var _user$project$Browser$itemToHtml = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0;
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Browser$ItemMsg(_p2),
		A2(_user$project$Item$view, _p2, _p1._1));
};
var _user$project$Browser$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Browser$navigationView(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$ul,
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Browser$itemToHtml,
...
var _user$project$Browser$AddItemToQueue = function (a) {
	return {ctor: 'AddItemToQueue', _0: a};
};
						...
						case 'DoubleClicked':
							...
							if (_p7.ctor === 'Group') {
								...
								return {
									ctor: '_Tuple2',
									_0: model_,
									_1: _user$project$Browser$AddItemToQueue(item_)
								};
							}
						case 'Clicked':
							if (isShiftDown) {
...
var _user$project$Chat$ChatModel = F3(
	function (a, b, c) {
		return {messages: a, newMessage: b, isMinimized: c};
	});
var _user$project$Chat$ToggleMinimize = {ctor: 'ToggleMinimize'};
var _user$project$Chat$minimizeButon = function (isMinimized) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Chat$ToggleMinimize),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				isMinimized ? '+ show chat' : '- hide chat'),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Chat$newMessageForm = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Chat$SendMessage),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Chat$SetNewMessage),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$MyStyle$chatBoxHeight(model.isMinimized),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: _user$project$Chat$minimizeButon(model.isMinimized),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					ctor: '::',
					_0: _user$project$Chat$newMessageForm(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$ul,
...
var _user$project$Chat$None = {ctor: 'None'};
var _user$project$Chat$PushMessage = function (a) {
	return {ctor: 'PushMessage', _0: a};
};
			...
			case 'SendMessage':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newMessage: ''}),
					_1: _user$project$Chat$PushMessage(model.newMessage)
				};
			case 'ReceiveMessage':
				var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Chat$chatMessageDecoder, _p0._0);
				if (_p1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Chat$None
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _user$project$Chat$None};
				}
			case 'SetNewMessage':
				return {
					ctor: '_Tuple2',
		...
		switch (_p8.ctor) {
			...
			case 'QueueItemMsg':
				...
				if (_p9.ctor === 'Just') {
					...
					var _p11 = A2(_elm_lang$core$Debug$log, 'queueItemCmd', queueItemCmd);
					if (_p11.ctor === 'Just') {
						switch (_p11._0.ctor) {
							case 'DoubleClicked':
								return {
			...
			case 'NextSong':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Queue$nextSong(model),
					_1: _user$project$Queue$None
				};
			case 'PreviousSong':
	...
	function (action, model) {
		...
		while (true) {
			...
			switch (_p4.ctor) {
				...
				case 'QueueMsg':
					var _p10 = A2(_user$project$Queue$update, _p4._0, model.queue);
					var queue_ = _p10._0;
					var queueCmd = _p10._1;
					var model_ = _elm_lang$core$Native_Utils.update(
						model,
						{queue: queue_});
					var _p11 = A2(_elm_lang$core$Debug$log, 'queueCmd', queueCmd);
					switch (_p11.ctor) {
						case 'RemoveItem':
							var _v10 = _user$project$Main$SendRemoveSong(_p11._0),
								_v11 = model_;
							action = _v10;
							model = _v11;
							continue update;
						case 'SwapItems':
							var _v12 = A2(_user$project$Main$SendSwapSongs, _p11._0._0, _p11._0._1),
								_v13 = model_;
							action = _v12;
							model = _v13;
							continue update;
				...
				case 'BrowserMsg':
					var _p12 = A3(_user$project$Browser$update, _p4._0, model.isShiftDown, model.browser);
							...
							if (_p14.ctor === 'Song') {
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model_,
										{
											queue: _elm_lang$core$Tuple$first(
												A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													'/',
													_elm_lang$core$Basics$toString(_p17.id)))))
								};
							}
						case 'ChangeRoute':
							var _p18 = _p13._0;
				...
				case 'ChatMsg':
					var _p19 = A2(_user$project$Chat$update, _p4._0, model.chat);
					var chat_ = _p19._0;
					var chatCmd = _p19._1;
					var _p20 = chatCmd;
					if (_p20.ctor === 'PushMessage') {
				...
				case 'OpenSongsInBrowser':
					if (_p4._0.ctor === 'Ok') {
						...
						var _p24 = A3(
							...
							model.isShiftDown,
							model.browser);
						var browser_ = _p24._0;
						var browserCmd = _p24._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
				...
				case 'UrlUpdate':
					var _p25 = _user$project$NavigationParser$urlParser(_p4._0);
					switch (_p25.ctor) {
						case 'ArtistsRoute':
							return {
								ctor: '_Tuple2',
						...
						case 'ArtistRoute':
							return {
								ctor: '_Tuple2',
								_0: model,
								_1: A2(_user$project$ApiHelpers$fetchSongsFromArtist, _p25._0, _user$project$Main$OpenSongsInBrowser)
							};
						case 'AlbumRoute':
							return {
								ctor: '_Tuple2',
								_0: model,
								_1: A2(_user$project$ApiHelpers$fetchSongsFromAlbum, _p25._0, _user$project$Main$OpenSongsInBrowser)
							};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'PhoenixMsg':
					var _p26 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p4._0, model.socket);
					var socket_ = _p26._0;
					var phxCmd = _p26._1;
					return {
						ctor: '_Tuple2',
				...
				case 'ReceiveNextSong':
					var _p28 = A2(_user$project$Queue$update, _user$project$Queue$NextSong, model.queue);
					var queue_ = _p28._0;
					var queueCmd = _p28._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'ReceivePreviousSong':
					var _p30 = A2(_user$project$Queue$update, _user$project$Queue$PreviousSong, model.queue);
					var queue_ = _p30._0;
					var queueCmd = _p30._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'ReceiveAddSongs':
					var _p32 = _user$project$ApiHelpers$decodeSongs(_p4._0);
					if (_p32.ctor === 'Ok') {
						var queueItems = _user$project$Helpers$makeSongItemList(_p32._0);
						var _p33 = A2(
							_user$project$Queue$update,
							_user$project$Queue$Drop(queueItems),
							model.queue);
						var queue_ = _p33._0;
						var queueCmd = _p33._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
				...
				case 'ReceiveSwapSongs':
					var _p37 = A2(
						_user$project$Queue$update,
						_user$project$Queue$Reorder(_p4._0),
						model.queue);
					var queue_ = _p37._0;
					var queueCmd = _p37._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'SendSwapSongs':
					...
					var _p38 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_, model.socket);
					var socket_ = _p38._0;
					var socketCmd = _p38._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				default:
					var _p39 = _user$project$ApiHelpers$decodeSync(_p4._0);
					if (_p39.ctor === 'Just') {
						var queueItems = A2(
							_elm_lang$core$Debug$log,
							'queue items',
							_user$project$Helpers$makeSongItemList(_p39._0._1));
						var _p40 = A2(
							_user$project$Queue$update,
							_user$project$Queue$Drop(queueItems),
							model.queue);
						var queue_ = _p40._0;
						var queueCmd = _p40._1;
						var queue__ = _elm_lang$core$Native_Utils.update(
							queue_,
							{currentSong: _p39._0._0});
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
