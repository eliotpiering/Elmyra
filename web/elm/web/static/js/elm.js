...
var _user$project$AlbumArt$view = function (picture) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('album-art-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MyModels$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {browser: a, queue: b, albumArt: c, currentMousePos: d, dragStart: e, keysBeingTyped: f, isShiftDown: g};
	});
	...
	return canDrop ? _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					'solid ',
					A2(_elm_lang$core$Basics_ops['++'], _user$project$MyStyle$grey, ' 2px'))
			},
			_1: {ctor: '[]'}
		}) : _elm_lang$html$Html_Attributes$style(
		{ctor: '[]'});
	...
	return isMouseOver ? _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'border',
				_1: A2(_elm_lang$core$Basics_ops['++'], '1px solid ', _user$project$MyStyle$grey)
			},
			_1: {ctor: '[]'}
		}) : _elm_lang$html$Html_Attributes$style(
		{ctor: '[]'});
...
var _user$project$Main$update = F2(
	function (action, model) {
		...
		switch (_p0.ctor) {
				...
				do {
					if (_p13.ctor === 'Just') {
						switch (_p13._0.ctor) {
							case 'BrowserWindow':
								var _p14 = dragEnd;
								if (_p14.ctor === 'QueueWindow') {
									var _p15 = A3(_user$project$Browser$update, _user$project$Browser$Reset, false, model.browser);
									...
									var selectedGroupItems = A2(
										_elm_lang$core$List$filter,
										function (_p16) {
											return !_user$project$Helpers$isSong(_p16);
										},
										A2(
											_elm_lang$core$List$filter,
											function (_) {
			...
			default:
				var _p18 = _user$project$NavigationParser$urlParser(_p0._0);
				switch (_p18.ctor) {
					case 'ArtistsRoute':
						return {
							ctor: '_Tuple2',
					...
					case 'ArtistRoute':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$ApiHelpers$fetchSongsFromArtist, _p18._0, _user$project$Main$OpenSongsInBrowser)
						};
					case 'AlbumRoute':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$ApiHelpers$fetchSongsFromAlbum, _p18._0, _user$project$Main$OpenSongsInBrowser)
						};
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Main$browserView = function (model) {
	var maybeMousePos = function () {
		var _p19 = model.dragStart;
		if ((_p19.ctor === 'Just') && (_p19._0.ctor === 'BrowserWindow')) {
...
var _user$project$Main$queueView = function (model) {
	var maybeMousePos = function () {
		var _p20 = model.dragStart;
		if ((_p20.ctor === 'Just') && (_p20._0.ctor === 'QueueWindow')) {
			return _elm_lang$core$Maybe$Just(model.currentMousePos);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
